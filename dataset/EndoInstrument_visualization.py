...
class EndoInstrumentSegmentation_visualization(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        target_path = self.images[index][1]

        return img, target, target_path

    def __len__(self):
        return len(self.images)

class EndoInstrumentSegmentationIncremental_visualization(data.Dataset):
    ...
    def __init__(
        ...
        self.dataset = EndoInstrumentSegmentation_visualization(root, file_path, train=train, transform=transform)
