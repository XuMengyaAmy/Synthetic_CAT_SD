...
DATASET=endo_instru
TASK=17-18
NAME=ILT_and_Intermediate_Shift_0_4_loss_de_100_Custumized_T
METHOD=ILT_and_Intermediate_Shift_0_4_loss_de_100_Custumized_T
...
SAVED=./checkpoints/step_trial_long
