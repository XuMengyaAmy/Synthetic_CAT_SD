...
Dataset_name = 'Harmonized_Blended_DDPM_Endo17'
train = True # Then please switch it to False
# '/home/ren2/data2/mengya/mengya_code/Synthesis_17/Synthesis/data_gen/blended/harmonized_blended_2_50_ddpm/'
blended_root = '/home/ren2/data2/mengya/mengya_code/Synthesis_17/Synthesis/data_gen/blended'
blended_dir = os.path.join(blended_root, 'harmonized_blended_2_50_ddpm')
...
if train:
    f=open("train_harmonized_blended_18_DDPM_17_memory500.txt","a")
    for line in fnames:
        print('line', line)
