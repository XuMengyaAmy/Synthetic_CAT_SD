...
# the published paper's split version, try to find the decent performance on 'old non-overlapping classes'
if train:
    split_list = [1,3,4,6,7,8] 
else:
    split_list = [2,5]
...
for folder_id in split_list:
    ...
    if train:
        ...
        # f=open("test_17_v2.txt","a")
        f=open("test_17_18_v2.txt","a") # You need to switch between test_17.txt and test_17_18.txt
        for line in fnames:
            # f.write(line+'\n') # 一列
            # f.write(Dataset_name+'\t'+line+'\n')# 两列
