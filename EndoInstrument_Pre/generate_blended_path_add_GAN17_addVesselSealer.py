...
Dataset_name = 'Harmonized_Blended_GAN_Endo17_addVesselSealer'
...
blended_root = '/home/ren2/data2/mengya/mengya_code/Synthesis_17/Synthesis/data_gen/blended_Vessel_Sealer'
...
if train:
    f=open("train_harmonized_blended_18_GAN_17_addVesselSealer_memory1000.txt","a")
    for line in fnames:
