...
Dataset_name = 'Harmonized_Blended_GAN_tmibg_Endo17'
train = True 

blended_root = '/home/ren2/data2/mengya/mengya_code/Synthesis_17/Synthesis/data_gen/blended'
blended_dir = os.path.join(blended_root, 'harmonized_blended_2_50_tmi_bg')
...
if train:
    f=open("/home/ren2/data2/mengya/mengya_code/CVPR2021_PLOP/EndoInstrument_Pre/train_harmonized_blended_18_GAN_17_tmibg_memory500.txt","a")
    for line in fnames:
